            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xl-5 pa-0">
                        <div class="auth-cover-img overlay-wrap" style="background-image:url(back/dist/img/bg1.jpg);">
                            ...
                            <div class="auth-form w-xxl-55 w-xl-75 w-sm-90 w-100">
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" placeholder="First name" value="" type="text" name="name">
                                    </div>
                                    <div class="form-group">

                        ...
                        <div class="listview listview--bordered">
                            <div class="listview__item">
                                <div class="listview__content">
                                    ...
                                    <div class="listview__attrs">
                                        <span><img class="widget-visitors__country" src="{{asset('back/demo/img/flags/United_States_of_America.png')}}" alt=""> United States</span>
                                        <span>Firefox</span>
                                        <span>Mac OSX</span>
                                    </div>
                                </div>
                            ...
                            <div class="listview__item">
                                <div class="listview__content">
                                    ...
                                    <div class="listview__attrs">
                                        <span><img class="widget-visitors__country" src="{{asset('back/demo/img/flags/Australia.png')}}" alt=""> Australia</span>
                                        <span>Chrome</span>
                                        <span>Android</span>
                                    </div>
                                </div>
                            ...
                            <div class="listview__item">
                                <div class="listview__content">
                                    ...
                                    <div class="listview__attrs">
                                        <span><img class="widget-visitors__country" src="{{asset('back/demo/img/flags/Brazil.png')}}" alt=""> Brazil</span>
                                        <span>Edge</span>
                                        <span>Windows</span>
                                    </div>
                                </div>
                            ...
                            <div class="listview__item">
                                <div class="listview__content">
                                    ...
                                    <div class="listview__attrs">
                                        <span><img class="widget-visitors__country" src="{{asset('back/demo/img/flags/South_Korea.png')}}" alt=""> South Korea</span>
                                        <span>Chrome</span>
                                        <span>Android</span>
                                    </div>
                                </div>
                            ...
                            <div class="listview__item">
                                <div class="listview__content">
                                    ...
                                    <div class="listview__attrs">
                                        <span><img class="widget-visitors__country" src="{{asset('back/demo/img/flags/Japan.png')}}" alt=""> Japan</span>
                                        <span>Chrome</span>
                                        <span>Windows</span>
                                    </div>
                                </div>

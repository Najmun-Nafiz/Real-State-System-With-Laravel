                ...
                <div class="content__inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="row" method="post" action="{{ route('admin.homedetails.update',$info -> id) }}" enctype="multipart/form-data">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select2" data-minimum-results-for-search="-1" data-placeholder="Select a make" name="category_id">
                                        	...
                                        	@foreach($infos as $v_info)
                                            	<option {{ $v_info -> id == $info->category->id ? 'selected' : '' }} value="{{ $v_info -> id }}">{{ $v_info -> name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Rate" name="rate" value="{{ $info -> rate }}" required>
                                    </div>

                ...
                <div class="content__inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="row" method="post" action="{{ route('admin.homeaddress.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select2" data-minimum-results-for-search="-1" data-placeholder="Select a make" name="home_id">
                                        	<option value=""></option>
                                        	@foreach($home_detail as $v_info)
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Neighborhood" name="neighborhood" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Postal_code" name="postal_code" required>
                                    </div>

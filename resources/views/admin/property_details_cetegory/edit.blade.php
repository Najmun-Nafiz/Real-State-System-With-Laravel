...
<section class="content">
                <div class="content__inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Update-Property-Details-Category</h4>
                            <div class="col-md-6">
                            ...
                            <form class="row" method="post" action="{{ route('admin.property_details_cetegory.update',$info -> id) }}" enctype="multipart/form-data">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <a class="col-md-5 btn btn-primary btn-block" href="{{ route('admin.property_details_cetegory.index') }}" style="background-color: red; color: #fff;border-color: #007bff;display: inline-block;font-size: 16.5px;margin-top: -2px; ">Back To Home</a>

...
<section class="content">
                <div class="content__inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Update-Lattetstwit</h4>
                            <div class="col-md-6">
                            ...
                            <form class="row" method="post" action="{{ route('admin.lattesttwit.update', $info -> id) }}" enctype="multipart/form-data">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Twitter" value="{{ $info -> twitter }}" name="twitter" required>
                                    </div>

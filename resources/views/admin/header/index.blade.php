                    ...
                    <table id="data-table" class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="center">
                                    <img class="img-responsive img-thumbnail" src="{{URL('uploads/header/'.$v_info->image)}}"  style = "height : 50px; width : 50px;border-radius: 50%" alt="">
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    @if($v_info -> status == true)
                                    <a href="{{ route('admin.header.unactive',$v_info->id) }}" style="background-color: green;padding: 4px 7px;margin-right: 5px; border-radius: 3px;">
                                        
                                        <i class="zwicon-checkmark-circle" style="color: white;font-size: 18px;"></i>
                                    </a>
                                    @else
                                    <a href="{{ route('admin.header.active',$v_info->id) }}" style="background-color: #908f8f;padding: 4px 7px;margin-right: 5px; border-radius: 3px;margin-top: 5px;">
                                        <i class="zwicon-close-circle" style="color: white;font-size: 18px;"></i>
                                    </a>
                                    @endif
                                    <a href="{{route('admin.header.edit',$v_info->id)}}" class="btn btn-info btn-sm"><i class="zwicon-edit-square-feather" style="color: white;font-size: 18px;"></i></a>
                                    
                                    <a href="{{route('admin.header.destroy',$v_info->id)}}" class="btn btn-danger btn-sm"><i class="zwicon-folder-delete" style="color: white;font-size: 18px;"></i></a>
                                </td>

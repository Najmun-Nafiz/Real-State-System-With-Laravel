                ...
                <div class="content__inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="row" method="post" action="{{ route('admin.late_property.update',$info -> id) }}" enctype="multipart/form-data">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Cost" name="cost" value="{{ $info -> cost }}" required>
                                    </div>

                                    <div class="form-group">
                                        <label style="font-size: 16px;">Space</label>
                                        <input type="text" class="form-control" placeholder="Space" name="space" value="{{ $info -> space }}" required>
                                    </div>

                                    <div class="form-group">
                                        <label style="font-size: 16px;">Room</label>
                                        <input type="text" class="form-control" placeholder="Room" name="room" value="{{ $info -> room }}" required>
                                    </div>

                                    <div class="form-group">
                                        <label style="font-size: 16px;">Bath</label>
                                        <input type="text" class="form-control" placeholder="Bath" name="bath" value="{{ $info -> bath }}" required>
                                    </div>

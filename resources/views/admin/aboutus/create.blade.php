                ...
                <div class="content__inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="row" method="post" action="{{ route('admin.aboutus.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Linkdin" name="linkdin" required>
                                    </div>

                                    <div class="form-group">
                                        <label style="font-size: 16px;">Github</label>
                                        <input type="text" class="form-control" placeholder="Github" name="github" required>
                                    </div>

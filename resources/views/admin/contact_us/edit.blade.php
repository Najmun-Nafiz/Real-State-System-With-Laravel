                ...
                <div class="content__inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="row" method="post" action="{{ route('admin.contact_us.update', $info -> id) }}" enctype="multipart/form-data">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $info -> local }}" class="form-control" placeholder="Local" name="local" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Website Address" name="web_address" value="{{ $info -> web_address }}" required>
                                    </div>

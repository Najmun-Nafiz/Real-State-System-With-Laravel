                ...
                <div class="content__inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h6 class="card-subtitle" style="margin-top: 10px;">You can easily add your project slider's from fillup this field and also showing in the main page.</h6>

                            <form class="row" method="post" action="{{ route('admin.slider.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Tota-Space" name="space" required>
                                    </div>

                                    <div class="form-group">
                                        <label style="font-size: 16px;">Bed-Room</label>
                                        <input type="text" class="form-control" placeholder="Bedroom" name="bed" required>
                                    </div>

                                    <div class="form-group">
                                        <label style="font-size: 16px;">Bath-Room</label>
                                        <input type="text" class="form-control" placeholder="Bathroom" name="bath" required>
                                    </div>
									...
									<div class="form-group">
                                        ...
                                        <textarea class="form-control" name="address" placeholder="Address Please" cols="7" rows="5" required></textarea>
                                    </div>
